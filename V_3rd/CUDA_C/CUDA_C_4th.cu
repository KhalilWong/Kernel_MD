...
void Parameters::Initialization(int All_type[], double All_Pos[][3], double All_Vel[][3], double All_Acc[][3]) {
	...
	__global__ void rescale_T4(double (*All_Vel)[3], double *Pt_T, double T[3]);
	...
	__global__ void Acceleration_period(double (*All_Pos)[3], double (*All_Acc)[3], double LJ_E[3], double LJ_S[3], double (*Box)[2], double *cutoff, double (*Pt_ePos)[3], double *spr_k, double Mass[2]);
