...
/******************************************************************************/
__global__ void Time_Advancement(Wall_Molecule *Pt, Gas_Molecule *Ar, Parameters_Wall *Pars_Pt, Parameters_Gas *Pars_Ar, Parameters_MD *Pars_MD) {
	//
...
void MD::MainMD() {
	...
	while(Pars_MD.State){
		...
		//
		Time_Advancement << < 1, Pt_N + Ar_N >> >(d_Pt, d_Ar, d_Pars_Pt, d_Pars_Ar, d_Pars_MD);
